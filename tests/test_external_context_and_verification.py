...
def test_continuation_candidates_respect_macro_veto() -> None:
    ...
    for bar in bars:
        ...
        micro.append(MicroFeatureSnapshot(ts=bar.ts, symbol="BTCUSDT", ofi_60s=200, median_bookimb_l10_60s=0.08, spread_z=0.2, vwap_mid_dev_30s_z=0.1, gate_pass_long=True, gate_pass_short=False))
